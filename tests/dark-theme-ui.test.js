...
test("key UI blocks are token driven for dark-theme safety", function () {
  const css = read("styles.css");

  const checks = [
    { sel: "body", must: ["var(--bg-gradient)"] },
    { sel: ".panel", must: ["var(--panel-bg)"] },
    ...
    { sel: "button.primary", must: ["var(--button-primary-bg)", "var(--border-strong"] },
  ];
