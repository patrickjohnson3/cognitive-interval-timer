(function bootstrapApp() {
  ...
  function createDOM() {
    return {
      ...
      cycleSummary: byId("cycle-summary"),
      cycleFocus: byId("cycle-focus"),
      cycleRecall: byId("cycle-recall"),
      cycleBreak: byId("cycle-break"),
      ...
      views: {
        ...
        settingsHeading: byId("settings-view-heading"),
      },
      controls: {
        start: byId("start"),
        skip: byId("skip"),
